...
class AdminUsersController extends AdminController {
    ...
    public function __construct(User $user, Role $role, Permission $permission)
    {
        ...
        if(!$this->business) throw new NotAllowedException;
    ...
    {
        // Grab all the users of the working business
        $users = $this->business->users;
        // Show the page
     ...
     * @return Response
     */
    public function getCreate($contact = null)
    {
        // All roles
        $roles = $this->role->all();
        ...
        // Show the page
        return View::make('admin/users/create', compact('roles', 'permissions', 'selectedRoles', 'selectedPermissions', 'contact'));
    }
     ...
     * @return Response
     */
    public function postCreate($contact = null)
    {
        ...
        if ( $this->user->id )
        {
            ...
            $this->user->businesses()->save($this->business);
