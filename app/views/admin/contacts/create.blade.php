...
@section('title')
@parent
	{{ trans('admin/contacts/title.create') }}
@stop

{{-- Content --}}
@section('content')
<div class="page-header">
	<h3>{{ trans('admin/contacts/title.create') }}
...
{{ Former::horizontal_open()->autocomplete('off') }}
	...
	<div class="tab-content">
			...
			<div class="control-group {{ $errors->has('birthdate') ? 'error' : '' }}">
				...
				<div class="controls">
					<div class="input-append date" data-date="{{ Input::old('birthdate') }}" data-date-format="yyyy-mm-dd" data-date-viewmode="decade">
						<input type="text" name="birthdate" id="birthdate" value="{{ Input::old('birthdate') }}" />
		...
		<div class="tab-pane" id="tab-extra">
			...
			<!-- Notes -->
			{{ Former::text('notes', _('admin/contacts/contacts.notes')) }}
		</div>
