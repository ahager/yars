    ...
    */
    ...
    'collections' => array(
        ...
        'public-js' => function($collection)
        {
            ...
            {
                ##$collection->add('jquery.v1.10.1.min.js');
                $collection->add('jquery.v1.8.0.min.js');
        ...
        'jquery-datepicker' => function($collection)
        {
            $collection->directory('assets/modules/datepicker', function($collection)
            {
                $collection->add('js/datepicker.js');
                $collection->add('css/datepicker.css');
            })->apply('UriRewriteFilter')->setArguments(public_path());
        },
        'bs-typeahead' => function($collection)
        {
            $collection->directory('assets/modules/typeahead', function($collection)
            {
                $collection->add('js/typeahead2.js');
            })->apply('UriRewriteFilter')->setArguments(public_path());
        },
        /*
